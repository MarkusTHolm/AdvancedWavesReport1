...
\begin{subfigure}[t]{.5\textwidth}
    \centering
    \includegraphics[width=0.95\textwidth,frame,trim=-0.3cm -0.2cm -0.3cm -0.5cm, clip=true]{Figures/Illustrations/MechanicalModelling.eps}
    \caption{Definition sketch of deformed system}
    \label{fig:MechanicalModel}
\end{subfigure}%
\begin{subfigure}[t]{.5\textwidth}
    \centering
    \includegraphics[width=0.95\textwidth,frame,trim=-0.2cm -0.2cm -0.25cm -0.5cm, clip=true]{Figures/Illustrations/MechanicalModellingFBD_v2.eps}
