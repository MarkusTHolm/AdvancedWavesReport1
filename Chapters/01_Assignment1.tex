...
\begin{subfigure}[t]{.5\textwidth}
    ...
    \caption{QQ plot of surface elevations versus standard normal}
    \label{fig:MechanicalModelFBD}
\end{subfigure}
\caption{Emperical distribution of the surface elevations shown in \cref{fig:SurfaceElevation}.}
\end{figure}
